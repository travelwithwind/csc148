...
class MultipleChoiceQuestion(Question):
    ...
    def __str__(self) -> str:
        ...
        """
        # TODO: complete the body of this method
        return 'Question:' + self.text + ' ' + 'Options:' + str(self._options)
...
class NumericQuestion(Question):
    ...
    def __str__(self) -> str:
        ...
        You can choose the precise format of this string.
        """
        return 'Question:' + self.text + ' ' + 'min:' + str(self._min) + ' ' \
               + 'max:' + str(self._max)
    ...
    def get_similarity(self, answer1: Answer, answer2: Answer) -> float:
        ...
        if self.validate_answer(answer1) and self.validate_answer(answer2):
            step1 = abs(answer1.content - answer2.content)
            step2 = step1 / (self._max - self._min)
            step3 = 1 - step2
            return step3
...
class CheckboxQuestion(MultipleChoiceQuestion):
    ...
    def get_similarity(self, answer1: Answer, answer2: Answer) -> float:
        ...
        """
        # TODO: complete the body of this method
        common = len(set(answer1.content).intersection(set(answer2.content)))
        total = len(set(answer1.content).union(set(answer2.content)))
        return common / total
...
class Survey:
    ...
    def __contains__(self, question: Question) -> bool:
        ...
        """
        # TODO: complete the body of this method
        _id = [q.id for q in list(self._questions.values())]
        if question.id in _id:
            return True
        return False
    ...
    def __str__(self) -> str:
        ...
        # TODO: complete the body of this method
        temp = ''
        for i, q in self._questions.items():
            temp = temp + 'Question%d:\n' % i + str(q) + '\n'
        return temp
    ...
    def _get_criterion(self, question: Question) -> Criterion:
        ...
        """
        # TODO: complete the body of this method
        cri = self._criteria.get(question.id)
        if cri:
            return cri
        else:
    ...
    def _get_weight(self, question: Question) -> int:
        ...
        """
        # TODO: complete the body of this method
        w = self._weights.get(question.id)
        if w:
            return w
        else:
    ...
    def score_students(self, students: List[Student]) -> float:
        ...
        try:
            ...
            for question in self._questions.values():
                #                print(question)
                cri = self._get_criterion(question)
                ...
                #                print([i.content for i in answers])

                before_weight_score = cri.score_answers(question, answers)
                scores.append(before_weight_score * w)
