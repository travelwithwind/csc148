...
class TestMultipleChoiceQuestion:
    ...
    def test_get_similarity(self) -> None:
        ...
        answer1 = Answer("A")
        answer2 = Answer("A")
        assert multi1.get_similarity(answer1, answer2) \
               == 1.0
...
class TestNumericQuestion:
    ...
    def test_get_similarity(self) -> None:
        ...
        answer1 = Answer(1)
        answer2 = Answer(1)
        assert numeric1.get_similarity(answer1, answer2) \
               == 1.0
...
class TestYesNoQuestionQuestion:
    ...
    def test_get_similarity(self) -> None:
        ...
        answer1 = Answer(True)
        answer2 = Answer(True)
        assert yesno1.get_similarity(answer1, answer2) \
               == 1.0
...
class TestCheckboxQuestion:
    ...
    def test_get_similarity(self) -> None:
        ...
        answer1 = Answer("A")
        answer2 = Answer("A")
        assert checkbox1.get_similarity(answer1, answer2) \
               == 1.0
